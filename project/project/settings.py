...
SECRET_KEY = 'django-insecure-0$!e7@5mei0^$zh*xyeg#hz=@1691v!er)r=dbw4&(^-pbypc#'
...
# قاعدة البيانات
if os.environ.get("RENDER"):  # إذا كنت على Render
    DATABASES = {
...
RESEND_API_KEY = os.getenv("re_RpymVwAP_He8ZmoAx4ArLxyERwSRStWrQ")